...
def get_solver(args):
    ...
    train_set = torch.utils.data.Subset(train_set, range(min(100, len(train_set))))  # First 10 samples
    valid_set = torch.utils.data.Subset(valid_set, range(min(10, len(valid_set))))    # First 2 samples
