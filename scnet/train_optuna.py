...
def get_solver(args, trial):
    ...
    #augment_remix_group_size = trial.suggest_int("augment.remix.group_size", 2, 2)
    ...
    train_set = torch.utils.data.Subset(train_set, range(min(1, len(train_set))))  # First 10 samples
